const { MIN_LENGTH, MAX_TITLE_LENGTH, MAX_DESC_LENGTH, MAX_TOPIC_LENGTH, MONGOOSE_ID_LENGTH, MIN_ANSWER_TIME } = require('../CONSTANTS');
...
const schema = {
    ...
    topics: Joi.array().items(Joi.string().lowercase().trim().min(MIN_LENGTH).max(MAX_TOPIC_LENGTH).required()).required(),
