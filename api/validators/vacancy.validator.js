const { MIN_LENGTH, MAX_TITLE_LENGTH, MAX_DESC_LENGTH, MONGOOSE_ID_LENGTH } = require('../CONSTANTS');
const Joi = require('@hapi/joi');
const validator = require('../services/validators.service');

const schema = {
    author: Joi.string().alphanum().length(MONGOOSE_ID_LENGTH).required(),
    ...
    questions: Joi.array().items(Joi.string().alphanum().length(MONGOOSE_ID_LENGTH).required()).required(),
