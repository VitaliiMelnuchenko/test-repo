...
router.route('')
.get(requireRoles(ADMIN, RECRUITER, REVIEWER) ,applicationController.getApplications)
.delete(requireRoles(RECRUITER, ADMIN), applicationController.deleteApplications);
